...
mkdir Payload
cp -r ID\ Changer.app Payload/ID\ Changer.app
strip Payload/ID\ Changer.app/ID\ Changer
zip -vr ID\ Changer.ipa Payload
rm -rf ID\ Changer.app
rm -rf Payload
